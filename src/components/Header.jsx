...
const Header = () => {
  ...
  return (
    <div className="fixed left-0 top-0 w-full z-20 bg-transparent lg:py-8 lg:left-8 lg:w-fit lg:min-h-screen">
      <header className="flex justify-between items-center bg-[#161D2F] px-4 py-[18px] lg:rounded-[20px] lg:min-h-[90vh] lg:flex-col">
        <Link to="/">
